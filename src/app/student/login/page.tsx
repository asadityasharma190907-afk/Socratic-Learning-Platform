          ...
          <form className="login-form" onSubmit={handleLogin}>
            <div className="form-group">
              ...
              <input 
                ...
                placeholder="e.g. s.12345@school.edu" 
                defaultValue="aarya.j" 
                required 
              />
            </div>
            <div className="form-group">
            ...
            <button type="submit" className="btn-select btn-student" style={{ width: '100%', marginTop: '1rem', justifyContent: 'center' }}>
